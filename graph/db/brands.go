...
var (
	brandAllColumns            = []string{"id", "name", "created_at", "updated_at"}
	brandColumnsWithoutDefault = []string{"id", "name"}
...
var brandAfterSelectMu sync.Mutex
var brandAfterSelectHooks []BrandHook

var brandBeforeInsertMu sync.Mutex
var brandBeforeInsertHooks []BrandHook
var brandAfterInsertMu sync.Mutex
var brandAfterInsertHooks []BrandHook

var brandBeforeUpdateMu sync.Mutex
var brandBeforeUpdateHooks []BrandHook
var brandAfterUpdateMu sync.Mutex
var brandAfterUpdateHooks []BrandHook

var brandBeforeDeleteMu sync.Mutex
var brandBeforeDeleteHooks []BrandHook
var brandAfterDeleteMu sync.Mutex
var brandAfterDeleteHooks []BrandHook

var brandBeforeUpsertMu sync.Mutex
var brandBeforeUpsertHooks []BrandHook
var brandAfterUpsertMu sync.Mutex
...
func (q brandQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Brand, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: failed to execute a one query for brands")
	}
...
func (q brandQuery) All(ctx context.Context, exec boil.ContextExecutor) (BrandSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "db: failed to assign all query results to Brand slice")
	}
...
func (q brandQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to count brands rows")
	}
...
func (q brandQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "db: failed to check if brands exists")
	}
...
func FindBrand(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Brand, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"brands\" where \"id\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "db: unable to select from brands")
	}
...
func (o *Brand) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("db: no brands provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to insert into brands")
	}
...
func (o *Brand) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db: unable to update brands, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update brands row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by update for brands")
	}
...
func (q brandQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all for brands")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected for brands")
	}
...
func (o BrandSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all in brand slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected all in update all brand")
	}
	return rowsAff, nil
}
...
func (o *Brand) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("db: no brands provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("db: unable to upsert brands, could not build update column list")
		}

		ret := strmangle.SetComplement(brandAllColumns, strmangle.SetIntersect(insert, update))
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"brands\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert brands")
	}
...
func (o *Brand) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no Brand provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete from brands")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by delete for brands")
	}
...
func (q brandQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db: no brandQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from brands")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by deleteall for brands")
	}
...
func (o BrandSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from brand slice")
	}
...
func (o *BrandSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to reload all in BrandSlice")
	}
...
func BrandExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"brands\" where \"id\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "db: unable to check if brands exists")
	}
